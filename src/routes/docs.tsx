...
const docSections: DocSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "Map visible Asana projects to existing VertexAI projects, or scaffold new VertexAI projects from selected Asana projects.",
    ...
    details: [
      ...
      "The mapping wizard filters out Asana projects where the connected user is not a project member.",
      "Scaffolding creates a local VertexAI project and a project chat that can receive Asana updates.",
      "Task submission is disabled for mapped projects unless Asana confirms project write access and the connection has tasks:write scope.",
    ...
    technicalDetails: [
      ...
      "The project picker uses Asana project membership checks for user=me before surfacing projects in the wizard.",
      "/api/asana-webhook delegates to handleAsanaWebhookRequest in src/lib/asana-webhook.ts and resolves project chats through asana_project_mappings before the optional legacy env map.",
      "The receiver verifies HMAC-SHA256 against the raw request body using ASANA_WEBHOOK_SECRET and accepts X-Asana-Request-Signature or Asana's standard X-Hook-Signature header.",
