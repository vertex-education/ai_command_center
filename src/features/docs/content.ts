...
const docSections: DocSection[] = [
  ...
  },
  {
    ...
    technicalDetails: [
      ...
      "uploadArtifact writes the raw file to ARTIFACTS_BUCKET, publishes a knowledge-item-upsert job to DOCUMENT_INGESTION_QUEUE, sets HTTP 202 Accepted, and returns queued.",
      "ingestGeneratedArtifact writes raw artifact text to R2 and queues a knowledge-item-upsert job.",
      "document-ingestion-worker handles queued jobs and owns expensive ingestion work: document text extraction, semantic chunking, vector_tenant_id resolution, embedTexts execution, D1 knowledge_items and knowledge_chunks writes, and Vectorize upserts.",
    ...
    blocks: [
      {
        ...
        items: [
          ...
          "document-ingestion-worker handles queued jobs and owns expensive ingestion work: document text extraction, semantic chunking, vector_tenant_id resolution, embedTexts execution, D1 knowledge_items and knowledge_chunks writes, and Vectorize upserts.",
          "wrangler.jsonc binds DOCUMENT_INGESTION_QUEUE as the producer for the main app, while wrangler.document-ingestion.jsonc declares the document-ingestion-queue consumer with batch size 5, timeout 30, and max retries 3.",
          "The knowledge item status starts as processing in the Queue consumer and finishes as completed or failed after background ingestion.",
        ],
      },
    ],
  },
