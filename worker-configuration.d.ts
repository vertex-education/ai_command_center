/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b096854cb28b285014f3ff1650a2ad2)
...
interface __BaseEnv_Env {
	...
	CHAT_SYNC: DurableObjectNamespace<import("./dist/server/index").ChatSyncDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/server/index");
		durableNamespaces: "ChatSyncDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_AI_GATEWAY_ID" | "TAVILY_API_KEY" | "FIRECRAWL_API_KEY">> {}
}
